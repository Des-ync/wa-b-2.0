...
// Passkeys are handled entirely by Clerk (clerk.skes.tech) — the web
// dashboard and the mobile app's Clerk WebView bridge both call Clerk's own
// SDK (user.createPasskey() / signIn.authenticateWithPasskey()) directly, no
// server-side WebAuthn ceremony of our own. See public/mobile-clerk-bridge.js.
