...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Future<List<Map<String, dynamic>>> _load() async {
    ...
    final res =
        await session.api.getNotifications(session.businessId!, limit: 100);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: AsyncList<Map<String, dynamic>>(
        ...
        emptySubtitle:
            'New orders, failed payments, low stock, and handoff requests show up here.',
        ...
        itemBuilder: (ctx, n) {
          ...
          return Card(
            ...
            child: Semantics(
              label: unread ? 'Unread notification' : null,
              child: ListTile(
