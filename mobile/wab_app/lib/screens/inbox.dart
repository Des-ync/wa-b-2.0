  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: AsyncList<Map<String, dynamic>>(
        ...
        emptySubtitle: 'Customer chats with your WhatsApp bot show up here.',
        emptyIcon: Icons.chat_bubble_rounded,
        itemBuilder: (ctx, c) {
          final name = (c['display_name'] ?? c['whatsapp_number'] ?? '?').toString();
          ...
          return Card(
            child: ListTile(
              ...
              trailing: Text(timeAgo(c['last_message_at'] ?? c['last_seen_at']),
